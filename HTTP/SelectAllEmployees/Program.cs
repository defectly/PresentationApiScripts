...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        try
        {
            Console.WriteLine("Retrieving all employees via HTTP API...");
            
            await SelectAllEmployeesAsync();
    ...
    private static async Task SelectAllEmployeesAsync()
    {
        ...
        var sortedEmployees = allEmployees.OrderBy(e => e.LastName).ThenBy(e => e.FirstName).ToList();
        ...
        Console.WriteLine($"\nTotal: {sortedEmployees.Count} employees");
    }
} 